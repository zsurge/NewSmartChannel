...
uint32_t bsp_infrared_scan ( void )
{
                    ...
                    |GETS17==0||GETS18==0 || GETS19==0||GETS20==0 || GETS21==0||GETS22==0 || GETS23==0||GETS24==0) )
	{
		...
		if ( GETS1==0 && key1_up==0)
		{
		 ...
		 if ( GETS2==0 && key2_up==0)
		{
            key2_up = 1;
			 iret |= (0x01<<1);
		}
		 if ( GETS3==0 && key3_up==0)
		{
            key3_up = 1;
			 iret |= (0x01<<2);
		}
		 if ( GETS4==0 && key4_up==0)
		{
            key4_up = 1;
			 iret |= (0x01<<3);
		}
		 if ( GETS5==0 && key5_up==0)
		{
            key5_up = 1;
			 iret |= (0x01<<4);
		}
		 if ( GETS6==0 && key6_up==0)
		{
            key6_up = 1;
			 iret |= (0x01<<5);
		}
		 if ( GETS7==0 && key7_up==0)
		{
            key7_up = 1;
			 iret |= (0x01<<6);
		}
		 if ( GETS8==0 && key8_up==0)
		{
            key8_up = 1;
			 iret |= (0x01<<7);
		}
		 if ( GETS9==0 && key9_up==0)
		{
            key9_up = 1;
			 iret |= (0x01<<8);
		}    
		 if ( GETS10==0 && key10_up==0)
		{
            key10_up = 1;
			 iret |= (0x01<<9);
		}
		 if ( GETS11==0 && key11_up==0)
		{
            key11_up = 1;
			 iret |= (0x01<<10);
		}   
		 if ( GETS12==0 && key12_up==0)
		{
            key12_up = 1;
			 iret |= (0x01<<11);
		}
		 if ( GETS13==0 && key13_up==0)
		{
            key13_up = 1;
			 iret |= (0x01<<12);
		}  
		 if ( GETS14==0 && key14_up==0)
		{
            key14_up = 1;
			 iret |= (0x01<<13);
		}
		 if ( GETS15==0 && key15_up==0)
		{
            key15_up = 1;
			 iret |= (0x01<<14);
		}  
		 if ( GETS16==0 && key16_up==0)
		{
            key16_up = 1;
			 iret |= (0x01<<15);
		}
		 if ( GETS17==0 && key17_up==0)
		{
            key17_up = 1;
			 iret |= (0x01<<16);
		}  
		 if ( GETS18==0 && key18_up==0)
		{
            key18_up = 1;
			 iret |= (0x01<<17);
		}
		 if ( GETS19==0 && key19_up==0)
		{
            key19_up = 1;
			 iret |= (0x01<<18);
		}    
		 if ( GETS20==0 && key20_up==0)
		{
            key20_up = 1;
			 iret |= (0x01<<19);
		}
		 if ( GETS21==0 && key21_up==0)
		{
            key21_up = 1;
			 iret |= (0x01<<20);
		}  
		 if ( GETS22==0 && key22_up==0)
		{
            key22_up = 1;
			 iret |= (0x01<<21);
		}
		 if ( GETS23==0 && key23_up==0)
		{
            key23_up = 1;
			 iret |= (0x01<<22);
		}  
		 if ( GETS24==0 && key24_up==0)
		{
            key24_up = 1;
			 iret |= (0x01<<23);
		}            
	...
	{        
		...
		if ( GETS2==1 && key2_up==1)
		{
            key2_up = 0;
			 iret &= ~(0x01<<1);
		}
		if ( GETS3==1 && key3_up==1)
		{
            key3_up = 0;
			 iret &= ~(0x01<<2);
		}
		if ( GETS4==1 && key4_up==1)
		{
            key4_up = 0;
			 iret &= ~(0x01<<3);
		}
		if ( GETS5==1 && key5_up==1)
		{
            key5_up = 0;
			 iret &= ~(0x01<<4);
		}
		if ( GETS6==1 && key6_up==1)
		{
            key6_up = 0;
			 iret &= ~(0x01<<5);
		}
		if ( GETS7==1 && key7_up==1)
		{
            key7_up = 0;
			 iret &= ~(0x01<<6);
		}
		if ( GETS8==1 && key8_up==1)
		{
            key8_up = 0;
			 iret &= ~(0x01<<7);
		}
		if ( GETS9==1 && key9_up==1)
		{
            key9_up = 0;
		     iret &= ~(0x01<<8);
		}    
		if ( GETS10==1 && key10_up==1)
		{
            key10_up = 0;
		     iret &= ~(0x01<<9);
		}
		if ( GETS11==1 && key11_up==1)
		{
            key11_up = 0;
		     iret &= ~(0x01<<10);
		}  
		if ( GETS12==1 && key12_up==1)
		{
            key12_up = 0;
			 iret &= ~(0x01<<11);
		}
		if ( GETS13==1 && key13_up==1)
		{
            key13_up = 0;
			 iret &= ~(0x01<<12);
		}  
		if ( GETS14==1 && key14_up==1)
		{
            key14_up = 0;
			 iret &= ~(0x01<<13);
		}
		if ( GETS15==1 && key15_up==1)
		{
            key15_up = 0;
			 iret &= ~(0x01<<14);
		}  
		if ( GETS16==1 && key16_up==1)
		{
            key16_up = 0;
			 iret &= ~(0x01<<15);
		}
		if ( GETS17==1 && key17_up==1)
		{
            key17_up = 0;
			 iret &= ~(0x01<<16);
		}  
		if ( GETS18==1 && key18_up==1)
		{
            key18_up = 0;
			 iret &= ~(0x01<<17);
		}
		if ( GETS19==1 && key19_up==1)
		{
            key19_up = 0;
			 iret &= ~(0x01<<18);
		}    
		if ( GETS20==1 && key20_up==1)
		{
            key20_up = 0;
			 iret &= ~(0x01<<19);
		}
		if ( GETS21==1 && key21_up==1)
		{
            key21_up = 0;
			 iret &= ~(0x01<<20);
		}  
		if ( GETS22==1 && key22_up==1)
		{
            key22_up = 0;
			 iret &= ~(0x01<<21);
		}
		if ( GETS23==1 && key23_up==1)
		{
            key23_up = 0;
			 iret &= ~(0x01<<22);
		}  
		if ( GETS24==1 && key24_up==1)
		{
            key24_up = 0;
			 iret &= ~(0x01<<23);
		}   
